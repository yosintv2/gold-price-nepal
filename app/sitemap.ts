...
const STATIC_PAGES = [
  ...
  { url: '/hallmark-gold-price-nepal-today/', priority: 0.88, changeFrequency: 'daily' as const },
  { url: '/fine-gold-9999-price-nepal/', priority: 0.85, changeFrequency: 'daily' as const },
  { url: '/fine-gold-9999-price-nepal-today/', priority: 0.83, changeFrequency: 'daily' as const },
  { url: '/24k-gold-price-nepal/', priority: 0.85, changeFrequency: 'daily' as const },
  { url: '/24k-gold-price-nepal-today/', priority: 0.83, changeFrequency: 'daily' as const },
  { url: '/tejabi-gold-price-nepal/', priority: 0.85, changeFrequency: 'daily' as const },
  { url: '/silver-price-nepal/', priority: 0.85, changeFrequency: 'daily' as const },
  { url: '/silver-price-nepal-today/', priority: 0.83, changeFrequency: 'daily' as const },
  { url: '/gold-price-nepal-per-tola/', priority: 0.8, changeFrequency: 'daily' as const },
  { url: '/gold-price-nepal-per-tola-today/', priority: 0.78, changeFrequency: 'daily' as const },
  { url: '/gold-price-nepal-per-10gm/', priority: 0.8, changeFrequency: 'daily' as const },
  { url: '/gold-price-nepal-per-10gm-today/', priority: 0.78, changeFrequency: 'daily' as const },
  { url: '/sunn-ko-bhau-aja/', priority: 0.82, changeFrequency: 'daily' as const },
  { url: '/ajako-sunn-ko-bhau/', priority: 0.82, changeFrequency: 'daily' as const },
